...
function Stats() {
    return (
        <div className='w-full flex'>
            {/* aside */}
            <Aside Menu={myLearning_2} />
            <div className='w-full ml-[334px] pt-[40px]'>
                {/* headers */}
                <div className='w-full flex items-center justify-end mb-[20px] pr-[40px]'>
                    {/* Left side */}
                ...
                <div className='flex gap-[40px]'>
                    ...
                    <div className='w-full pt-[40px]'>
                        <h1 className="text-[24px] mb-[10px] text-center">Learning Center</h1>
                        <h2 className="text-[18px] text-center">Module 1</h2>
                    ...
                    <div className='min-w-[230px] pr-[40px] flex flex-col justify-between pb-[170px]' style={{ height: "calc(100vh - 46px)" }}>
                        <p className='w-full mb-[10px] tags rounded-[10px] min-h-[100px] text-[12px] flex p-[15px] mt-[200px]'>SCORE</p>
                    </div>
                </div>
