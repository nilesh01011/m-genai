...
function Header() {
  return (
    <div className='w-full flex items-center justify-between pl-[40px] pr-[40px] pt-[30px]'>
      {/* logo */}
      <Link to="/" className='h-[35px]'>
        <img alt="logo" src="./mgen-ai-white.png" className='w-full h-full object-contain' />
      </Link>
      {/* Left side */}
